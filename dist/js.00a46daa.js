...
function _getStudentById() {
  _getStudentById = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var r, data;
...
function _addStudent() {
  _addStudent = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(student) {
    var r, data;
...
function _updateStudent() {
  _updateStudent = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id, updated) {
    var r, data;
